    ...
    <>
      ...
      <Modal id={uniqueId}>
        <div className="w-screen max-w-md">
          ...
          <button className="inline-flex items-center px-5 py-2.5 mr-2 lg:mr-3 text-gray-100 text-center text-sm lg:text-lg font-medium bg-red-600 border border-red-800 rounded-lg hover:grayscale-[20%] focus:ring-4 focus:outline-none focus:ring-red-400/50" onClick={handleDelete}>Hapus</button>
