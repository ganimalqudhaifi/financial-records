    ...
    <>
      ...
      <nav className="absolute top-[90%] lg:static w-full lg:w-auto h-0 lg:h-auto">
        <ul className="w-full lg:mt-0 rounded-lg overflow-hidden lg:flex ">
          ...
          <li className={`${!isNavigationDropdownOpen ? 'opacity-0 invisible' : 'opacity-100 visible'} duration-500 lg:opacity-100 lg:visible last:lg:hidden last:border-t-2 last:border-gray-500 active:brightness-200 active:duration-[0ms]`}><Link href="#Contact" className="block px-5 py-[10px] text-gray-200 font-medium duration-200 bg-gray-700 hover:bg-gray-600 hover:duration-[0ms] hover:text-main-color lg:bg-transparent lg:px-6 lg:hover:bg-transparent lg:duration-[0ms]">Contact</Link></li>
