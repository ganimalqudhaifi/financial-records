  ...
  return (
    <>
      ...
      <Modal style="modal-content-delete" action={action}>
        ...
        <button className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm lg:text-lg inline-flex items-center px-5 py-2.5 text-center mr-2 lg:mr-3" onClick={() => (!isDemo ? deleteRecord(isDemo, id) : dispatch(deleteRecord(isDemo, id)))}>Hapus</button>
