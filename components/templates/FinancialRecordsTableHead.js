...
import { closeModal, hideModal, showModal } from '../../context/action/demoAction'
import { Button, Input, Text, Wrapper } from '../atoms'
  ...
  return (
    <>
      ...
      <tr>
        ...
        <th ></th>
        <th >Rp {saldoAwal.toLocaleString('id-ID')}</th>
        <td >
